...
class D3ForceNet extends Component {
	constructor(){
		...
		this.initializeNodeDisplay = this.initializeNodeDisplay.bind(this)
		this.initializeLinkDisplay = this.initializeLinkDisplay.bind(this)
	...
	rerun = () => {
		this.initializeLinkDisplay();
		this.initializeNodeDisplay();
	...
	renderUpdateSelected(){
		...
		/////////filter - reset data
		if (this.props.lastClicked==="dateRange" | this.props.lastClicked==="filterData" | this.props.lastClicked==="timeline") {
