...
import concrete1 from "../concrete1.jpg"
...
class Bar3D extends Component {
	...
	drawMirrorSphere = () => {
		...
		let sphereGeo =  new THREE.SphereGeometry(size, 20, 20);
		mirrorSphere = new THREE.Mesh(sphereGeo, sphereMaterial);
		mirrorSphere.position.set(0, size/2+1, 0);
	...
	stepForward = () => {
		mirrorSphere.position.x +=.01
		mirrorSphere.rotation.z += .02
